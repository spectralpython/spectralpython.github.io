...
should be able to start IPython for SPy like this::
...
To save an image display to a file, use the :func:`~spectral.save_rgb` function,
which uses the same arguments as :func:`~spectral.imshow` but with the saved image
