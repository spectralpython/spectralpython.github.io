...
scores much higher than other pixels. To view greater detail in the RX image,
we can either use a nonlinear color scale or - as shown below - we can scale the
data prior to displaying the image:
