# -*- coding: utf-8 -*-
#
# Spectral Python documentation build configuration file, created by
...
project = u'Spectral Python'
copyright = u'2010, Thomas Boggs'
...
htmlhelp_basename = 'SpectralPythondoc'
...
latex_documents = [
  ('index', 'SpectralPython.tex', u'Spectral Python Documentation',
   u'Thomas Boggs', 'manual'),
]
